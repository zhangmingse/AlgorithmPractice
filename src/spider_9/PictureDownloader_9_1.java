...
public class PictureDownloader_9_1 implements Runnable {
	...
	public PictureDownloader_9_1(String _url, int _index) {
	...
	public void run() {
		...
		try {
			...
			if (file != null && file.exists()) {
				...
				file.delete();//must close associated stream before delete, otherwise it would fail.
